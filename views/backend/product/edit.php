                     ...
                     <div class="row">
                        <div class="col-md-9">
                           ...
                           <input type="hidden" value="<?=$product->id;?>" name="id">
                              ...
                              <input type="text" value="<?=$product->name;?>" value placeholder="Nhập tên sản phẩm" name="name" class="form-control">
                           </div>
                           <div class="mb-3">
                              <label>Slug</label>
                           ...
                           <div class="mb-3">
                              ...
                              <textarea name="detail" value="<?=$product->detail;?>" placeholder="Nhập chi tiết sản phẩm" rows="5"
                                 class="form-control"></textarea>
                           </div>
                           <div class="mb-3">
                              <label>MÔ tả (*)</label>
                              <textarea name="description" value="<?=$product->description;?>" placeholder="Nhập mô tả sản phẩm" rows="5"
                                 class="form-control"></textarea>
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="mb-3">
                              <label>Giá bán (*)</label>
                              <input type="number" value="<?=$product->price;?>"  min="1000" name="price" class="form-control">
                           </div>
                           <div class="mb-3">
                              <label>Giá sale (*)</label>
                              <input type="number" value="<?=$product->pricesale;?>" min="100" name="pricesale" class="form-control">
                           </div>
                           <div class="mb-3">
                              <label>Số lượng</label>
                              <input type="number" value="<?=$product->id;?>" placeholder="Nhập số lượng" name="qty" class="form-control">
                           </div>
                           <div class="mb-3">
